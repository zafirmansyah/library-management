...
var BooksService = function () {
    ...
    var BooksService = _classThis = /** @class */ (function () {
        function BooksService_1(bookRepository) {
        ...
        BooksService_1.prototype.create = function (createBookDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    book = this.bookRepository.create(createBookDto);
                    return [2 /*return*/, this.bookRepository.save(book)];
                });
            });
        };
        // Ambil Semua Buku
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            book = _a.sent();
                            if (!book)
                                throw new common_1.NotFoundException("Buku dengan ID ".concat(id, " tidak ditemukan"));
        ...
        BooksService_1.prototype.update = function (id, updateBookDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.bookRepository.update(id, updateBookDto)];
                        case 1:
                            _a.sent();
        ...
        BooksService_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.bookRepository.delete(id)];
                        case 1:
                            result = _a.sent();
